  ...
  render() {
    return (
      <div>
        ...
        />
        <section id="team">
          <h2 className="text-center mt-5"> Meet the Doers & Builders </h2>
          <Shield />
          <div className="container container-team mb-5 pb-3">
            <Cards name="Shivam" post="Full-Stack Developer" src={shiv} />
            <Cards name="Aakriti" post="Front End Developer" src={aaku} />
            <Cards name="Kirti" post="Web Developer" src={kirti} />
            <Cards name="Anam" post="Web Designer" src={anam} />
          </div>
        </section>
        <Footer />
      </div>
